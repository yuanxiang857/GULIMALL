...
public class PurchaseController {
     ...
     */
    @PostMapping("/done")
    public R doneList(@RequestBody PurchaseDoneVo purchaseDoneVo) {
    ...
    public R mergeList(@RequestBody List<Long> ids) {
    ...
    ///ware/purchase/merge 合并采购单

    @PostMapping("/merge")
    public R mergeList(@RequestBody MergeVo mergeVo) {
        purchaseService.mergePurchaseItem(mergeVo);
        return R.ok();
    }
    /**
     * 列表
